...
class Recipe:
    ...
    def __str__(self):
        ...
        components_str = ", ".join(component.value for component in self.meal_components)
    ...
    def from_dict(cls, data: dict):
        ...
        meal_components = [MealComponent(component) for component in data["meal_components"]]
        return cls(
            name=data["name"],
